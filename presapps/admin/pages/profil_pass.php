...
<section class="content">
  ...
  <div class="card">
    ...
    <form action="../action_admin/profil.php" method="POST">
      ...
      <div class="card-body">
      	<div class="row">
              ...
              <div class="col-sm-8">
                <input type="password" name="password_lama" class="form-control" id="password_lama" required="" placeholder="Password Lama">
              </div>
            </div>
    			</div>
    		</div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="password" name="password_baru" class="form-control" id="password_baru" required="" placeholder="Password Baru">
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="password" name="kpassword_baru" class="form-control" id="kpassword_baru" required="" placeholder="Konfirmasi Password Baru">
              </div>
            </div>
          </div>
        </div>
