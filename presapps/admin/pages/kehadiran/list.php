...
<section class="content">
  ...
  <div class="card">
    ...
    <div class="card-body">
        ...
        <tbody>
          <?php 
            include "../action_admin/kehadiran.php";
            $no = 1;
          ...
          <tr>
            ...
            <td>
            	...
            	<a onclick="return confirm('Hapus kehadiran?')" href="index.php?page=kehadiran&action=delete&id=<?php echo $i['id_kehadiran']; ?>" class="btn btn-danger">
